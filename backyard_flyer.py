...
class BackyardFlyer(Drone):
    ...
    def local_position_callback(self):
        ...
        """
        #print("Inside Local Position Callback")
        if self.flight_state == States.TAKEOFF:
            ...
            a = self.target_position[0:2]
            b = self.local_position[0:2]
            remaining_waypoints = len(self.all_waypoints)
    ...
    def waypoint_transition(self):
        ...
        next_point = self.all_waypoints.pop(0)
        current_pos = self.local_position
        xx = round(current_pos[0])
        yy = round(current_pos[1])
        zz = round(current_pos[2])
        print("Waypoint Transition: [{0}, {1}, {2}]  ==>  {3}".format(xx, yy, abs(zz), next_point))
        self.target_position = next_point
        self.cmd_position(
